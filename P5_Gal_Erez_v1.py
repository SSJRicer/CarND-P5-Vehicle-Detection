...
# Getting an image shape (X, Y):
example_img = cv2.imread(test_imgs_path + 'test1.jpg')
img_w = example_img.shape[1]
img_h = example_img.shape[0]
img_size = (img_w, img_h)  # 1280x720
